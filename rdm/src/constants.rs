...
/* DBUS CONSTANTS */
pub const DBUS_SERVICE_NAME: &'static str = "com.github.1wilkens.RDM";
pub const DBUS_ROOT_PATH: &'static str = "com/github/1wilkens/RDM";
...
/* -- X SERVER SETTINGS --*/
pub const X_DEFAULT_ARGS: [&'static str; 5] = ["-nolisten", "tcp", "-logverbose", "75", "-noreset"];
