...
impl<'a, C: ::std::ops::Deref<Target=dbus::Connection>> OrgFreedesktopLogin1Manager for dbus::ConnPath<'a, C> {
    ...
    fn list_seats(&self) -> Result<Vec<(String, dbus::Path<'static>)>, Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"ListSeats".into(), |_| {
        }));
        try!(m.as_result());
        let mut i = m.iter_init();
        let arg0: Vec<(String, dbus::Path<'static>)> = try!(i.read());
        Ok(arg0)
    }

    fn power_off(&self, arg0: bool) -> Result<(), Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"PowerOff".into(), |msg| {
    ...
    fn reboot(&self, arg0: bool) -> Result<(), Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"Reboot".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(arg0);
        }));
        try!(m.as_result());
    ...
    fn halt(&self, arg0: bool) -> Result<(), Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"Halt".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(arg0);
        }));
        try!(m.as_result());
    ...
    fn suspend(&self, arg0: bool) -> Result<(), Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"Suspend".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(arg0);
        }));
        try!(m.as_result());
    ...
    fn hibernate(&self, arg0: bool) -> Result<(), Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"Hibernate".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(arg0);
        }));
        try!(m.as_result());
    ...
    fn hybrid_sleep(&self, arg0: bool) -> Result<(), Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"HybridSleep".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(arg0);
        }));
        try!(m.as_result());
    ...
    fn can_power_off(&self) -> Result<String, Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"CanPowerOff".into(), |_| {
        }));
        try!(m.as_result());
        let mut i = m.iter_init();
    ...
    fn can_reboot(&self) -> Result<String, Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"CanReboot".into(), |_| {
        }));
        try!(m.as_result());
        let mut i = m.iter_init();
        let arg0: String = try!(i.read());
    ...
    fn can_halt(&self) -> Result<String, Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"CanHalt".into(), |_| {
        }));
        try!(m.as_result());
        let mut i = m.iter_init();
        let arg0: String = try!(i.read());
    ...
    fn can_suspend(&self) -> Result<String, Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"CanSuspend".into(), |_| {
        }));
        try!(m.as_result());
        let mut i = m.iter_init();
        let arg0: String = try!(i.read());
    ...
    fn can_hibernate(&self) -> Result<String, Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"CanHibernate".into(), |_| {
        }));
        try!(m.as_result());
        let mut i = m.iter_init();
        let arg0: String = try!(i.read());
    ...
    fn can_hybrid_sleep(&self) -> Result<String, Self::Err> {
        let mut m = try!(self.method_call_with_args(&"org.freedesktop.login1.Manager".into(), &"CanHybridSleep".into(), |_| {
        }));
        try!(m.as_result());
        let mut i = m.iter_init();
        let arg0: String = try!(i.read());
...
impl dbus::SignalArgs for OrgFreedesktopLogin1ManagerSeatNew {
    ...
    fn get(&mut self, i: &mut arg::Iter) -> Result<(), arg::TypeMismatchError> {
        self.arg0 = try!(i.read());
        self.arg1 = try!(i.read());
        Ok(())
    }
}
